Start a new feature branch following the project workflow.
...
6. Confirm the branch was created and remind the user:
   ...
   - When done: rebase onto dev, fast-forward merge, push dev directly
   - Or open a PR targeting `dev` if you want CI to run first
